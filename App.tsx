        ...
        <header className="bg-light-bg dark:bg-dark-bg p-4 md:px-8 flex items-center justify-between sticky top-0 z-20 h-16 shadow-sm border-b border-gray-200 dark:border-gray-800">
            ...
            {user && (
                <div className="flex items-center space-x-4">
                     <button onClick={() => onNavigate('notifications')} className="relative w-[34.0px] h-[34.0px] flex items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors" aria-label="Notifications">
                        <BellIcon className="w-[20.5px] h-[20.5px]" />
                    ...
                    <button onClick={() => onNavigate('wallet')} className="flex items-center space-x-2 bg-gradient-to-r from-primary to-secondary text-white font-bold px-[16.7px] py-[6.7px] rounded-full text-[15.5px] hover:opacity-90 transition-opacity shadow-lg shadow-primary/30" data-testid="header-wallet-button">
                        <WalletHeaderIcon className="w-[20.5px] h-[20.5px]" />
